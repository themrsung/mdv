...
| Selection sync (`EditorSurface`) | Needs a live `contenteditable`, a real `selectionchange`, and a real focus/blur cycle. The offset mapping underneath it *is* covered here. |
...
7. Switch the OS between light and dark with the theme control on *System*.
