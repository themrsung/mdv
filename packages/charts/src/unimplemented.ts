...
const PERMISSIVE_CHANNELS: readonly ChannelSpec[] = [
  { name: 'x', required: false, accepts: [], list: true, constant: true, doc: 'Not interpreted: this type is not implemented at this conformance level.' },
  { name: 'y', required: false, accepts: [], list: true, constant: true, doc: 'Not interpreted: this type is not implemented at this conformance level.' },
  { name: 'series', required: false, accepts: [], doc: 'Not interpreted: this type is not implemented at this conformance level.' },
  { name: 'color', required: false, accepts: [], constant: true, doc: 'Not interpreted: this type is not implemented at this conformance level.' },
  { name: 'size', required: false, accepts: [], constant: true, doc: 'Not interpreted: this type is not implemented at this conformance level.' },
  { name: 'shape', required: false, accepts: [], constant: true, doc: 'Not interpreted: this type is not implemented at this conformance level.' },
  { name: 'label', required: false, accepts: [], doc: 'Not interpreted: this type is not implemented at this conformance level.' },
  { name: 'value', required: false, accepts: [], list: true, doc: 'Not interpreted: this type is not implemented at this conformance level.' },
  { name: 'category', required: false, accepts: [], doc: 'Not interpreted: this type is not implemented at this conformance level.' },
  { name: 'group', required: false, accepts: [], doc: 'Not interpreted: this type is not implemented at this conformance level.' },
  { name: 'detail', required: false, accepts: [], doc: 'Not interpreted: this type is not implemented at this conformance level.' },
  { name: 'tooltip', required: false, accepts: [], list: true, doc: 'Not interpreted: this type is not implemented at this conformance level.' },
];
...
export const UNIMPLEMENTED_TYPES: readonly UnimplementedSpec[] = [
  ...
  { name: 'histogram', level: 2, summary: 'a histogram of the binned distribution' },
  ...
  { name: 'ohlcv', level: 2, aliases: ['candlestick'], summary: 'a candlestick price-and-volume chart' },
  ...
  { name: 'waterfall', level: 2, summary: 'a waterfall of the running total' },
];
